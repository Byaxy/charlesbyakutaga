...
export const experiencesData = [
  {
    ...
    description: [
      "Took part in implementing a tax collection system for the Liberia Revenue Authority.",
      "Handle the Electronic Fiscal Devices integration with the MILIKI system to facilitate taxpayer invoice monitoring.",
      "Debug and resolve any software-related issues with deployed Electronic Fiscal Devices to the taxpayer business area.",
    ],
  ...
  },
  {
    ...
    description: [
      "Developed and led the implementation of the hospital website for long-term strategic plans and solutions.",
      "Supported the implementation and training of staff on the hospital management system. Conducted training sessions, created user guides, and provided personalized support to ensure high user adoption of the new system. Received positive feedback from management and staff.",
      "Provided technical support and leadership on a variety of hospital activities requiring expertise in Information Technology.",
    ],
  ...
  },
  {
    ...
    description: [
      "Reviewed voter’s application forms, recognizing and promptly addressing discrepancies.",
      "Registered new voters by inputting their bio-metric data into the Voter Registration System promptly.",
    ],
  ...
  },
  {
    ...
    description: [
      "Created and managed property files, recognizing and promptly addressing discrepancies.",
      "On-boarded new properties by inputting their data into the Computer-Aided Mass Valuation Database system.",
    ],
    icon: React.createElement(CgWorkAlt),
