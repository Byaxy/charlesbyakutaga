  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center">
        ...
        <motion.div
          className="flex flex-col sm:flex-row items-center justify-center mb-6 gap-4 px-4 text-lg font-medium"
          initial={{ opacity: 0, y: 100 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{
            delay: 0.1,
        ...
        <motion.div
          className="flex flex-row items-center justify-center gap-2 sm:gap-4 px-4 text-lg font-medium"
          initial={{ opacity: 0, y: 100 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{
            delay: 0.125,
        ...
        >
          <a
            ...
            href="https://www.linkedin.com/in/charles-byakutaga/"
            target="_blank"
          >
            <BsLinkedin />
          </a>
